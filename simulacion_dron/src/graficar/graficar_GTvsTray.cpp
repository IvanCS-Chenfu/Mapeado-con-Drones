...
class Clase_Subscriber : public rclcpp::Node
{
    public:
        Clase_Subscriber() : rclcpp::Node("graficar_GTvsTray")
        {
            ...
            objeto_subscriber_feedback = this->create_subscription<dron_individual::action::TrayAction_FeedbackMessage>(
    ...
    private:
        ...
        rclcpp::Subscription<dron_individual::action::TrayAction_FeedbackMessage>::SharedPtr objeto_subscriber_feedback;
