...
class Clase_Subscriber : public rclcpp::Node
{
    public:
        ...
        {
            objeto_subscriber = this->create_subscription<dron_individual::action::TrayAction_FeedbackMessage>(
    ...
    private:
        ...
        rclcpp::Subscription<dron_individual::action::TrayAction_FeedbackMessage>::SharedPtr objeto_subscriber;
