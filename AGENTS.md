...
codex_index:
  ...
  subfases_dir: codex/pipeline/fase_3_sparse_global/subfases/
  historial_dir: codex/pipeline/fase_3_sparse_global/historial/por_subfase/
...
- No iniciar otras fases mientras Fase 3 siga abierta salvo petición
  explícita.
...
- mantener `codex/pipeline/fase_3_sparse_global/subfases/subfase_<ID>.md`
...
codex/pipeline/fase_3_sparse_global/historial/por_subfase/
