...
- La política visual de estado perdido/stale ya está acordada: conservar última
  pose válida, marcar `PERDIDO` y bajar opacidad/énfasis visual.

## Archivos permitidos a modificar

```text
src/servidor/multidron_gui_lib/src/ros_data_bridge.*
src/servidor/multidron_gui_lib/include/multidron_gui_lib/ros_data_bridge.*
src/servidor/multidron_gui_lib/src/gui_data_model.*
src/servidor/multidron_gui_lib/include/multidron_gui_lib/gui_data_model.*
