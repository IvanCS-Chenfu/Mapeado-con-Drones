...
```text
src/servidor/multidron_gui/src/selection/
src/servidor/multidron_gui/include/multidron_gui/selection/
src/servidor/multidron_gui/src/render/selection_layer.*
src/servidor/multidron_gui/src/widgets/selection_inspector.*
...
```text
TaskManager / planner / GO_TO backend
