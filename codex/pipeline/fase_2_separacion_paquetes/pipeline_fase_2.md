...
Este pipeline es un contrato de trabajo. No contiene resultados de build ni de
simulación. Cuando se ejecute una subfase, la evidencia deberá registrarse en
los historiales que se creen entonces dentro de `historial/por_subfase/`.
...
### Réplicas parciales entre grupos
...
`inertia_total` al YAML físico, crea réplicas parciales entre grupos, separa
...
- las réplicas parciales entre grupos están declaradas y verificadas;
