...
namespace lib_tray
{
    ...
    class GenTrayElipse
    {
        ...
        private:
            ...
            void evaluar_trayectoria(const CoefElipse & c, double t, std::vector<std::array<double, 5>> & salida) const;
            ...
            void comprobar_tamano_vector(const std::vector<double> & vector, const char * nombre_vector, std::size_t tamano) const;
