...
class TrayActionGUI(Node):
    ...
    def _build_gui(self):
        ...
        self.var_relativo = tk.DoubleVar(value=self.defaults["relativo"])
        ...
        add_slider(r, "z (m)", self.var_z, (-1.0, 10.0)); r += 1
        ...
        add_slider(r, "relativo", self.var_relativo, (0.0, 1.0), fmt="{:.0f}"); r += 1
    ...
    def _on_send(self):
        ...
        relativo = bool(round(self.var_relativo.get()))
